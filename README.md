...
This repository contains ai voice agent for ecommerce, built using the VideoSDK Agents architecture with a [Pipeline (Cascade Mode)](https://docs.videosdk.live/ai_agents/core-components/pipeline).
...
- A VideoSDK [API Key and Secret Key](https://app.videosdk.live?utm_source=ai-voice-agent-for-ecommerce&utm_medium=github-repo-auto&utm_campaign=github-repo-auto)
